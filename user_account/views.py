...
def usersignup(request):
    ...
    elif request.method == "GET" and request.path.startswith("/signup/ajax/load_departments"):

        school_id = request.GET.get("school_id", None)
        response = school_departments[school_id]
        return JsonResponse(response, safe=False)
    elif request.method == "GET" and request.path.startswith("/signup/ajax/load_school"):
